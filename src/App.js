              ...
              <Routes>
                {!isAuthenticated ? (
                  ...
                  <>
                    ...
                    <Route path='customer/status/:status' element={<CustomerList />} />
                    <Route path='customer/id/:customerId' element={<CustomerDetails />} />
                    <Route path='agent' element={<AgentList />} />
                    <Route path='agent/status/:status' element={<AgentList />} />
                    ...
                    <Route path='/gold/:status' element={<GoldTransaction />} />
                    <Route path='/silver' element={<SilverTransaction />} />
                    <Route path='/silver/:status' element={<GoldTransaction />} />
